...
@new
  Scenario: Add a measurement with new metric (numeric) values
    # POST /measurements
    When I submit a new measurement as follows:
      | timestamp                  | temperature | dewPoint | precipitation | windSpeed |
      | "2015-08-01T16:00:00.000Z" | 27.1        | 16.7     | 0             | 10        |
    Then the response has a status code of 201
    And the Location header has the path "/measurements/2015-08-01T16:00:00.000Z"
